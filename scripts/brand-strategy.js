/* ================================================================
   Growthhive — Brand Strategy & Identity Discipline Page Script
   brand-strategy.js
...
const SECTION_ACCENTS = [
  ...
  new THREE.Color(0xD4F53C),    // 1 belief — chartreuse
  new THREE.Color(0x0B0B1F),    // 2 delivers — navy
  new THREE.Color(0xD4F53C),    // 3 process — chartreuse
  new THREE.Color(0x0B0B1F),    // 4 directions — navy
  new THREE.Color(0xD4F53C),    // 5 studio — chartreuse
  new THREE.Color(0x0B0B1F),    // 6 engage — navy
  new THREE.Color(0xD4F53C),    // 7 closer — chartreuse
];
...
window.onLoaderComplete = function() {
  ...
  tl.to('#bsEyebrow', { opacity:1, y:0, duration:1.0, ease:'power3.out' }, .4)
    .to('#bsTitle',   { opacity:1, y:0, duration:1.6, ease:'power4.out' }, .65)
    .to('#bsSub',     { opacity:1, y:0, duration:1.2, ease:'power3.out' }, 1.1)
    .to('#bsMeta',    { opacity:1, duration:1.2, ease:'power3.out' }, 1.5);
  ...
  const sects = [
    ['.bs-hero',0],['.bs-belief',1],['.bs-delivers',2],
    ['.bs-process',3],['.bs-directions',4],
    ['.bs-studio',5],['.bs-engage',6],['.bs-closer',7],
  ];
