/* ================================================================
   Growthhive — PR & Communications Discipline Page Script
   pr-communications.js
...
const SECTION_ACCENTS = [
  ...
  new THREE.Color(0x0B0B1F),    // 4 directions
  new THREE.Color(0xD4F53C),    // 5 studio — JP Morgan
...
window.onLoaderComplete = function() {
  ...
  tl.to('#prEyebrow', { opacity:1, y:0, duration:1.0, ease:'power3.out' }, .4)
    .to('#prTitle',   { opacity:1, y:0, duration:1.6, ease:'power4.out' }, .65)
    .to('#prSub',     { opacity:1, y:0, duration:1.2, ease:'power3.out' }, 1.1)
    .to('#prMeta',    { opacity:1, duration:1.2, ease:'power3.out' }, 1.5);
  ...
  const sects = [
    ['.pr-hero',0],['.pr-belief',1],['.pr-delivers',2],
    ['.pr-process',3],['.pr-directions',4],
    ['.pr-studio',5],['.pr-engage',6],['.pr-closer',7],
  ];
