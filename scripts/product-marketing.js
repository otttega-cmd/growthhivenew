/* ================================================================
   Growthhive — Product Marketing Discipline Page Script
   product-marketing.js
...
window.onLoaderComplete = function() {
  ...
  tl.to('#pmEyebrow', { opacity:1, y:0, duration:1.0, ease:'power3.out' }, .4)
    .to('#pmTitle',   { opacity:1, y:0, duration:1.6, ease:'power4.out' }, .65)
    .to('#pmSub',     { opacity:1, y:0, duration:1.2, ease:'power3.out' }, 1.1)
    .to('#pmMeta',    { opacity:1, duration:1.2, ease:'power3.out' }, 1.5);
  ...
  var sects = [
    ['.pm-hero',0],['.pm-belief',1],['.pm-caps',2],
    ['.pm-process',3],['.pm-directions',4],
    ['.pm-studio',5],['.pm-engage',6],['.pm-closer',7]
  ];
