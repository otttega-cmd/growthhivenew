/* ================================================================
   Growthhive — Ansarada / Tender Case Study Script
   ansarada.js
...
const SECTION_ACCENTS = [
  new THREE.Color(0x004D43),    // 0 hero — deep teal
  new THREE.Color(0xE07B38),    // 1 brief — amber
  new THREE.Color(0x009B8A),    // 2 insight — teal
  new THREE.Color(0xE07B38),    // 3 concept — amber
  new THREE.Color(0x009B8A),    // 4 cities — teal
  new THREE.Color(0xE07B38),    // 5 format — amber
  new THREE.Color(0x009B8A),    // 6 scope — teal
  new THREE.Color(0xE07B38),    // 7 outcomes/download — amber
  new THREE.Color(0x009B8A),    // 8 closer — teal
];
...
window.onLoaderComplete = function() {
  ...
  tl.to('#tnEyebrow', { opacity:1, y:0, duration:1.0, ease:'power3.out' }, .4)
    .to('#tnTitle',   { opacity:1, y:0, duration:1.8, ease:'power4.out' }, .7)
    .to('#tnTagline', { opacity:1, y:0, duration:1.4, ease:'power3.out' }, 1.2)
    .to('#tnMeta',    { opacity:1, y:0, duration:1.2, ease:'power3.out' }, 1.6)
    .to('#tnCities',  { opacity:1, duration:1.2, ease:'power3.out' }, 2.0);
  ...
  // ── Scene accents ──────────────────────────────────────────────
  const sects = [
    ['.tn-hero',0],['.tn-brief',1],['.tn-insight',2],
    ['.tn-concept',3],['.tn-cities',4],['.tn-format',5],
    ['.tn-scope',6],['.tn-outcomes',7],['.tn-download',7],
    ['.tn-closer',8],
  ];
